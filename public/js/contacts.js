                ...
                <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <div class="contact-card p-3" data-contact-id="${contact.id}">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button class="btn btn-sm btn-outline-success" onclick="quickCall('${contact.phone_number}')" title="Call">
                                <i class="bi bi-telephone"></i>
                            </button>
                            <button class="btn btn-sm btn-outline-info" onclick="quickSms('${contact.phone_number}')" title="SMS">
        ...
        container.innerHTML = `
            ...
            <div class="list-group">
                ...
                <div class="list-group-item">
                    ...
                    <strong>Notes:</strong><br>${contact.notes}
                </div>
                ` : ''}
            </div>
        `;
